...
@app.command()
def convert(
    input_file: str = typer.Option(..., "--input", "-i", help="Input markdown or YAML file path"),
    force: bool = typer.Option(False, "--force", "-F", help="Overwrite output files without asking"),
    output_dir: str = typer.Option("output", "--output-dir", "-o", help="Directory to store output files"),
    debug: bool = typer.Option(False, "--debug", "-d", help="Enable debug mode"),
    verbose: bool = typer.Option(False, "--verbose", help="Show verbose error messages and suggestions"),
    skip_yaml_lint: bool = typer.Option(False, "--no-yaml-lint", help="Skip running yamllint on YAML content (validation is enabled by default)"),
):
